...
There are lot of participant who didn't got MCI at the end of the research, all '.' are 
replaced as Na. I didn't filter them out since it might still be useful when we want to do 
analysis using models like logistic regression according to their APOE4 status and they 
