...
The size of the merged dataframe is 747 x 14. The `plastic_bags` variables for Mr.Trash wheel and Professor Trash wheel are the total of `chip_bags` and `grocery_bags` since Gwynnda trash wheel didn't separately count different bags. 
...
There are 16 participants appear only in the Mmyloid dataset and 8 participants appear only in the baseline dataset. 
