...
replaced as Na. I didn't filter them out since it might still be useful when we want to 
analysis like logistic regression according to their APOE4 status and they also contains 
informations. 
